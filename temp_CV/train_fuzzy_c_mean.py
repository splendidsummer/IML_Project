...
if __name__ == '__main__':
    ...
    if data_index == 0:
        # k_range_list = range(2, 15, 1)  # k value list
        k_range_list = range(2, 4, 1)
    ...
    for i, metric in enumerate(metrics_list):
        for j, k_clusters in enumerate(k_range_list):
            ...
            for train_idx, test_idx in kfold.split(data, labels):
                ...
                cluster = fuzzyCMeans(k_clusters, train_data, random_state, max_iter=1000)
        ...
        df_results[metric] = results
        csv_path = 'Fuzzy_C_Means {} evaluation result.csv'.format(dataset_name)
